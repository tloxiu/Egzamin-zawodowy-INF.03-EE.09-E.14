...
<body>
    ...
    <main class="blok-glowny">
        ...
        <?php
        $secondquery = 'SELECT DISTINCT swinki.data_ur, swinki.miot, rasy.rasa FROM swinki JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy.id = 6;';
        ...
        <?php
        $thirdquery = 'SELECT imie, cena, opis FROM swinki WHERE rasy_id = 6;';
